...
- Social Card Toolkit controls now mirror the shared single-active accordion behavior, with focused-section scrolling and non-active sections hidden while editing to fix issue #46 parity gaps.
